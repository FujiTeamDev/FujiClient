...
<h1 align="center">Fuji Client</h1>
...
| -------- | ---- |
| Windows x64 | [Fuji-Client-win-x64.exe](../../..//releases/latest/download/Fuji-Client-win-x64.exe) |
| macOS x64/arm64(silicon) | [Fuji-Client-mac-universal.zip](../../..//releases/latest/download/Fuji-Client-mac-universal.zip) |
| Linux x64 | [Fuji-Client-linux-x86_64.AppImage](../../..//releases/latest/download/Fuji-Client-linux-x86_64.AppImage) |
---
